...
//       {/* Header Section */}
//       <div className="text-center">
//         <h4 className="text-orange-600 font-semibold text-lg tracking-widest uppercase">
//           {t("how_it_works")}
//         </h4>
//         <h2 className="text-4xl font-bold text-[#162F56] mt-2 leading-snug">
//           {t("easy_steps_to_apply")} <br />
//           <span className="text-orange-600">{t("for_government_schemes")}</span>
//         </h2>
//         <p className="text-gray-700 mt-4 text-lg">{t("follow_steps")}</p>
//       </div>
...
//             <Search size={50} color="white" />
//           </div>
//           <h3 className="text-xl font-semibold text-[#162F56] mt-4">{t("search")}</h3>
//           <p className="text-gray-600 w-64 mt-2">
//             {t("search_description")}
//           </p>
//         </div>
...
//             <FileText size={50} color="white" />
//           </div>
//           <h3 className="text-xl font-semibold text-[#162F56] mt-4">{t("enter_details")}</h3>
//           <p className="text-gray-600 w-64 mt-2">
//             {t("enter_details_description")}
//           </p>
//         </div>
...
//             <MousePointerClick size={50} color="white" />
//           </div>
//           <h3 className="text-xl font-semibold text-[#162F56] mt-4">{t("select_apply")}</h3>
//           <p className="text-gray-600 w-64 mt-2">
//             {t("select_apply_description")}
//           </p>
//         </div>
